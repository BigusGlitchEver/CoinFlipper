...
-- ---------- Board assignment ----------
-- Maps each house (lower-case name) to an ordered list of board module paths,
-- one per floor. This is the ONLY place a board is bound to a floor: swap a
-- board by changing a single string here. No geometry lives in this file.
M.HOUSE_FLOORS = {
  grandma = {
    "data.boards.grandmas_table",   -- floor 1
